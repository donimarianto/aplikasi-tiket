...
<div class="d-flex justify-content-between flex-wrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h1">Edit Tiket/Event</h1>
</div>
    <div class="col-md-8 offset-md-2">
        <form action="{{ route('updateEvent',$tiket->id) }}" method="post">
            @csrf
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama tiket">
                </div>
            </div>
            <div class="form-group">
